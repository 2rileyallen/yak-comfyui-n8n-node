...
:: ==========================================================================
:: Yak ComfyUI Node - Environment Setup Script (v4.0 - Modern Stack)
:: ==========================================================================
echo.
...
echo [STEP 1/6] Checking for prerequisites (Git, Python, and Conda)...
where git >nul 2>&1
...
echo [STEP 2/6] Setting up OFFICIAL ComfyUI repository...
...
echo [STEP 3/6] Configuring Conda environment '!ENV_NAME!'...
...
echo [STEP 5/6] Installing Sage Attention and its dependencies...
...
echo [STEP 6/6] Installing the ComfyUI-Manager...
